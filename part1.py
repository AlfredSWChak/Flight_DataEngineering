...
def showAllAirports():
    ...
    fig = px.scatter_geo(file, hover_name='name', 
                         lat='lat', 
                         lon = 'lon', 
                         color='alt',
...
def analyzeTimeZone():
    ...
    fig = px.scatter_geo(tz_file, hover_name='name', 
                         lat='lat', lon='lon', color='tz',
                         color_continuous_scale='rdbu',)
    
    fig.update_layout(title = 'All the airports with different time zones')
    fig.update_coloraxes(colorbar_title_text='Time zones')
    fig.show()
